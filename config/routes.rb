Rails.application.routes.draw do
  ...
  resources :partidos do
    ...
    get "/ingresos_campana", to: 'partidos#ingresos_campana'
    get "/egresos_campana", to: 'partidos#egresos_campana'
    get "/contrataciones_20utm", to: 'partidos#contrataciones_20utm'
    ...
    get "/detalles_candidatos", to: "partidos#detalles_candidatos"
