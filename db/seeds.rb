...
Distrito.create!([
  ...
  {circunscripcion_id: 2, nombre: "2"},
  {circunscripcion_id: 3, nombre: "3"},
  {circunscripcion_id: 4, nombre: "4"},
  {circunscripcion_id: 5, nombre: "5"},
  {circunscripcion_id: 6, nombre: "6"},
  {circunscripcion_id: 6, nombre: "7"},
  {circunscripcion_id: 7, nombre: "8"},
  {circunscripcion_id: 7, nombre: "9"},
  {circunscripcion_id: 7, nombre: "10"},
  {circunscripcion_id: 7, nombre: "11"},
  {circunscripcion_id: 7, nombre: "12"},
  {circunscripcion_id: 7, nombre: "13"},
  {circunscripcion_id: 7, nombre: "14"},
  {circunscripcion_id: 8, nombre: "15"},
  {circunscripcion_id: 8, nombre: "16"},
  {circunscripcion_id: 9, nombre: "17"},
  {circunscripcion_id: 9, nombre: "18"},
  {circunscripcion_id: 10, nombre: "19"},
  {circunscripcion_id: 10, nombre: "20"},
  {circunscripcion_id: 10, nombre: "21"},
  {circunscripcion_id: 11, nombre: "22"},
  {circunscripcion_id: 11, nombre: "23"},
  {circunscripcion_id: 12, nombre: "24"},
  {circunscripcion_id: 13, nombre: "25"},
  {circunscripcion_id: 13, nombre: "26"},
  {circunscripcion_id: 14, nombre: "27"},
  {circunscripcion_id: 15, nombre: "28"}
])
