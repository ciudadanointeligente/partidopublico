...
results[:acuerdos_organos] = {new: 0,
                   errors: 0,
                   found: 0}
...
pre_process do
  ...
  p "*** Start #{job_name} AcuerdosOrganos MIGRATION #{results[:start_time]}***"
end
...
destination AcuerdosOrganosDestination, verbose: verbosing, results: results
