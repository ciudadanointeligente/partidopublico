...
pre_process do
  ...
  p "*** Start #{job_name} Requisitos para afiliación MIGRATION #{results[:start_time]}***"
end
...
destination TramiteDestination, verbose: verbosing, results: results
