...
results[:estadistica_cargos] = {new: 0,
                   errors: 0,
                   found: 0}
...
pre_process do
  ...
  p "*** Start #{job_name} estadistica_cargos MIGRATION #{results[:start_time]}***"
end
...
destination EstadisticaCargosDestination, verbose: verbosing, results: results
