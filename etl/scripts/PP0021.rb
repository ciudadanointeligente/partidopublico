...
results[:egreso_ordinarios] = {new: 0,
                   errors: 0,
                   found: 0}
...
pre_process do
  ...
  p "*** Start #{job_name} Egresos Ordinarios MIGRATION #{results[:start_time]}***"
end
...
destination EgresoOrdinarioDestination, verbose: verbosing, results: results
