...
system("DATE=#{date} bundle exec kiba etl/scripts/PP0017.rb")
system("DATE=#{date} bundle exec kiba etl/scripts/PP0019.rb")
system("DATE=#{date} bundle exec kiba etl/scripts/PP0020.rb")
system("DATE=#{date} bundle exec kiba etl/scripts/PP0021.rb")
