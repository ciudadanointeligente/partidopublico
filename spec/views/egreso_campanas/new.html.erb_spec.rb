...
RSpec.describe "egreso_campanas/new", type: :view do
  before(:each) do
    assign(:egreso_campana, EgresoCampana.new(
      :partido => nil,
  ...
  xit "renders new egreso_campana form" do
    render

    assert_select "form[action=?][method=?]", egreso_campanas_path, "post" do
